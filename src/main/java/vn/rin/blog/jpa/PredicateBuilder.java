...
import vn.rin.blog.jpa.specification.*;
...
public class PredicateBuilder<T> {
    ...
    public PredicateBuilder<T> ge(boolean condition, String property, Comparable<? extends Object> compare) {
        return this.predicate(condition, new GteSpecification(property, compare));
    }
    ...
    public PredicateBuilder<T> le(boolean condition, String property, Comparable<?> compare) {
        return this.predicate(condition, new LteSpecification(property, compare));
    }
    ...
    public PredicateBuilder<T> isNotEmpty(String property) {
        return this.predicate(true, new NotEmptySpecification(property));
    }
