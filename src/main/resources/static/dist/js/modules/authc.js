define(function(require, exports, module) {
    ...
    var Authc = {
        isAuthced: function () {
            return (typeof(RIN_BLOG.LOGIN_TOKEN) !== 'undefined' && RIN_BLOG.LOGIN_TOKEN.length > 0);
        },
        showLogin : function () {
            var that = this;
            $('#login_alert').modal();
        ...
        doPostLogin: function () {
            ...
            jQuery.post(RIN_BLOG.BASE_PATH + '/api/login', {'username': un, 'password': pw}, function (ret) {
                if (ret && ret.code == 0) {
