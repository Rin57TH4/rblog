    ...
    <div class="row users-show">
        ...
        <div class="col-xs-12 col-md-9 side-right">
            <div class="panel panel-default">
                <div class="panel-heading">Bài viết đã xuất bản</div>
                <@user_contents userId=user.id pageNo=pageNo status=0>
                                    ...
                                    <div class="pull-right hidden-xs">
                                        <#if owner>
                                            <a class="act_edit" href="javascript:void(0);" data-evt="edit"
                                               data-id="${row.id}" data-toggle="tooltip" title="Chỉnh sửa bài viết">
                                                <i class="icon icon-note"></i>
                                            </a>
                                            <a class="act_delete" href="javascript:void(0);" data-evt="trash"
                                               data-id="${row.id}" data-toggle="tooltip" title="Xóa bài viết">
