...
<head>
    ...
    <title>Quản lý nền - ${options['site_name']}</title>
    ...
    <script type="text/javascript">
        var RIN_BLOG = RIN_BLOG || {};
        RIN_BLOG.BASE_PATH = '${base}';
        RIN_BLOG.LOGIN_TOKEN = '${profile.id}';
    </script>
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="${base}/index" class="logo">
            ...
            <span class="logo-lg"><b>RIN</b>BLOG</span>
        </a>
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <li><a href="/" title="Nhảy lên tiền cảnh" target="_blank"><i class="fa fa-television"></i></a></li>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="${base}/settings/profile" class="btn btn-default btn-flat">Dữ liệu cá nhân</a>
                                </div>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2019 <a href="#">Rin Blog</a>.</strong> All rights reserved.
    </footer>
</body>
</html>
</#macro>
