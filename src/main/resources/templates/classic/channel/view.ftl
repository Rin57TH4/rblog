    ...
    <div class="col-xs-12 col-md-9 side-left topics-show">
        ...
        <div class="topic panel panel-default">
            ...
            <div class="more-box">
                <a class="btn btn-fulltext" data-toggle="fulltext">
                    <i class="icon icon-arrow-down" aria-hidden="true"></i> Đọc tất cả
                </a>
            </div>
        </div>
        ...
        <div id="chat" class="chats shadow-box">
            <div class="chat_header">
                <h4>Tất cả bình luận: <span id="chat_count">0</span></h4>
            </div>
            <ul id="chat_container" class="its"></ul>
            <div id="pager" class="text-center"></div>
            <div class="chat_post">
                <div class="cbox-title">Tôi có vài điều muốn nói: <span id="chat_reply" style="display:none;">@<i
                        id="chat_to"></i></span>
                </div>
                <div class="cbox-post">
                    <div class="cbox-input">
                        <textarea id="chat_text" rows="3" placeholder="Vui lòng nhập một bình luận"></textarea>
                    ...
                    <div class="cbox-ats clearfix">
                        ...
                        <div class="ats-issue">
                            <button id="btn-chat" class="btn btn-success btn-sm bt">Gửi</button>
                        </div>
                    </div>
                </div>
        ...
        <ul class="list-group about-user">
            ...
            <li class="list-group-item">
                <div class="user-datas">
                    <ul>
                        <li><strong>${view.author.posts}</strong><span>Xuất bản</span></li>
                        <li class="noborder"><strong>${view.author.comments}</strong><span>Nhận xét</span></li>
                    </ul>
                </div>
            </li>
            <li class="list-group-item">
                <div class="text-center">
                    <a class="btn btn-default btn-sm" href="javascript:void(0);" data-id="${view.id}" rel="favor">
                        <i class="icon icon-star"></i> Yêu thích <strong id="favors">${view.favors}</strong>
                    </a>
                </div>
            </li>
        </ul>
