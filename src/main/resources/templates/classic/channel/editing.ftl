        ...
        <div class="col-xs-12 col-md-4 side-right">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Đăng lên</h3>
                </div>
                <div class="panel-body">
                    <select class="form-control" name="channelId" required>
                        <option value="">Vui lòng chọn một kênh</option>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Thẻ (cách nhau bằng dấu phẩy hoặc dấu cách)</h3>
                </div>
                <div class="panel-body">
            ...
            <div class="col-xs-12 col-md-12">
                <div class="form-group">
                    <div class="text-center">
                        ...
                        <button type="button" data-status="1" class="btn btn-danger" event="post_submit" style="padding-left: 30px; padding-right: 30px;">Bản thảo</button>
                    </div>
                </div>
            </div>
        </div>
