            ...
            <div class="panel-body">
                ...
                <form id="submitForm" method="POST" action="register" accept-charset="UTF-8">
                    <div class="form-group ">
                        ...
                        <input class="form-control" id="username" name="username" type="text" placeholder="Kết hợp các chữ cái và số, không ít hơn 5 chữ số" required>
                    </div>
                    <@controls name="register_email_validate">
                        <div class="form-group">
                            <label class="control-label" for="username">Hộp thư</label>
