...
<div class="alert alert-danger alert-dismissible fade in" role="alert" style="margin-bottom:0">
	...
	<strong>Bạn đang sử dụng một trình duyệt cũ hơn.</strong> Hiệu ứng hiển thị trên trang này có thể khác nhau.
    Chúng tôi khuyên bạn nên nâng cấp lên
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
					...
					<#list channels as row>
                        ...
                        <li>
                            <a href="${base}/tags" nav="tags">Tag</a>
                        </li>
                </ul>
